...
export const QUESTIONS: Question[] =[
  ...
  new Question(12,"With all your beetle friends now in the pockets of your jacket, life is feeling good again. You stumble upon a door with a sign that says 'Exit'. You give it a push and sunlight streams upon your countenance.","Leave the building","Go back inside", 17, 16),
